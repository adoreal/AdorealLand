...
namespace SOLIDApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            adorealLand.ThemeParkRides.Add(new OfficeSpaceRide("Office Space Ride", 10, "Printer Smash Finale"));
            ...
            adorealLand.Restaurants.Add(new GauchoRestaurant("Gaucho Steakhouse", 10, 8, "Picanha"));
